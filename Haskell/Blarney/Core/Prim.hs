...
, semEval :: forall a. PrimSample a => [a] -> [a]
...
primInfo (Const w x) =
  PrimInfo { isInlineable = True
           ...
           , strRep = "Const" ++ show x
           , semEval = \_ -> [clamp w (fromIntegral x)]
           , dontKill = False
           , isRoot = False
           , inputs = []
           , outputs = [("out", w)] }
...
primInfo (Div w) =
  PrimInfo { isInlineable = True
           , inputsInlineable = True
           , strRep = "Div"
           , semEval = \[i0, i1] -> [clamp w $ i0 `div` i1]
           , dontKill = False
           , isRoot = False
           , inputs = [("in0", w), ("in1", w)]
           , outputs = [("out", w)] }
primInfo (Mod w) =
  PrimInfo { isInlineable = True
           , inputsInlineable = True
           , strRep = "Mod"
           , semEval = \[i0, i1] -> [clamp w $ i0 `mod` i1]
           , dontKill = False
           , isRoot = False
           , inputs = [("in0", w), ("in1", w)]
           , outputs = [("out", w)] }
primInfo (Not w) =
  PrimInfo { isInlineable = True
           , inputsInlineable = True
           , strRep = "Not"
           , semEval = \[i0] -> [clamp w $ complement i0]
           , dontKill = False
           , isRoot = False
           , inputs = [("in", w)]
           , outputs = [("out", w)] }
...
primInfo (Xor w) =
  PrimInfo { isInlineable = True
           , inputsInlineable = True
           , strRep = "Xor"
           , semEval = \[i0, i1] -> [clamp w $ i0 `xor` i1]
           , dontKill = False
           , isRoot = False
           , inputs = [("in0", w), ("in1", w)]
           , outputs = [("out", w)] }
primInfo (ShiftLeft iw ow) =
  PrimInfo { isInlineable = True
           , inputsInlineable = True
           , strRep = "ShiftLeft"
           , semEval = \[i0, i1] -> [clamp ow $ i0 `shiftL` fromIntegral i1]
           , dontKill = False
           , isRoot = False
...
primInfo (ShiftRight iw ow) =
  PrimInfo { isInlineable = True
           ...
           , semEval = \[i0, i1] -> [clamp ow $ i0 `shiftR` fromIntegral i1]
           , dontKill = False
           , isRoot = False
           , inputs = [("in0", ow), ("in1", iw)]
           , outputs = [("out", ow)] }
...
primInfo (Equal w) =
  PrimInfo { isInlineable = True
           , inputsInlineable = True
           , strRep = "Equal"
           , semEval = \[i0, i1] -> [if i0 == i1 then 1 else 0]
           , dontKill = False
           , isRoot = False
           , inputs = [("in0", w), ("in1", w)]
           , outputs = [("out", 1)] }
...
primInfo (ReplicateBit w) =
  PrimInfo { isInlineable = True
           , inputsInlineable = True
           , strRep = "ReplicateBit"
           , semEval = \[i0] -> [clamp w if i0 == 0 then zeroBits
...
primInfo (SignExtend iw ow) =
  PrimInfo { isInlineable = True
           ...
           , strRep = "SignExtend"
           , semEval = \[i0] -> let sgn = testBit i0 (iw - 1)
...
primInfo (SelectBits iw hi lo) =
  PrimInfo { isInlineable = True
           , inputsInlineable = False
           , strRep = "SelectBits"
           , semEval = \[i0] -> [clamp (hi + 1) i0 `shiftR` lo]
           , dontKill = False
           , isRoot = False
           , inputs = [("in", iw)]
           , outputs = [("out", hi - lo + 1)] }
primInfo (Concat w0 w1) =
  PrimInfo { isInlineable = True
           , inputsInlineable = True
           , strRep = "Concat"
           , semEval = \[i0, i1] -> [clamp (w0 + w1) $ i0 `shiftL` w1 + i1]
           , dontKill = False
           , isRoot = False
...
primInfo (Mux n w) =
  PrimInfo { isInlineable = False
           , inputsInlineable = True
           , strRep = "Mux"
           , semEval = \(s:is) -> [is !! fromIntegral s]
           , dontKill = False
           , isRoot = False
...
primInfo prim@(Register _ w) =
  PrimInfo { isInlineable = False
           , inputsInlineable = True
           , strRep = "Register"
           , semEval = err $ "no semEval for " ++ show prim
           , dontKill = False
           , isRoot = False
           , inputs = [("in", w)]
           , outputs = [("out", w)] }
